...
import org.waveprotocol.box.webclient.client.atmosphere.AtmosphereConnectionState;
 ...
 *
 */
public class SearchConnectionImpl implements AtmosphereConnection {


      private static final class AtmosphereSocket extends JavaScriptObject {
        public static native AtmosphereSocket create(SearchConnectionImpl impl, String urlBase) /*-{
      ...
      var client = $wnd.atmosphere;
                ...
                connectionUrl += 'atmosphere/dateone/search/';
                ...
                atsocket.request.onOpen = $entry(function() {
                    impl.@com.greycells.dateone.client.search.SearchConnectionImpl::onConnect()();
                });
                ...
                atsocket.request.onMessage =  $entry(function(response) {
                  ...
                  if (r.indexOf('|') == 0) {
                      ...
                      while (r.indexOf('|') == 0 && r.length > 1) {
                        ...
                        impl.@com.greycells.dateone.client.search.SearchConnectionImpl::onMessage(Ljava/lang/String;)(r.substring(0, marker+1));
                    ...
                    impl.@com.greycells.dateone.client.search.SearchConnectionImpl::onMessage(Ljava/lang/String;)(r);
                ...
                atsocket.request.onClose = $entry(function(response) {
                   ...
                   impl.@com.greycells.dateone.client.search.SearchConnectionImpl::onDisconnect(Ljava/lang/String;)(response);
                });
    ...
    public SearchConnectionImpl(AtmosphereConnectionListener listener,
               String urlBase) {
    ...
    public void connect() {
        if (socket == null) {
            ...
            ScriptInjector.fromUrl("/atmosphere/wave/atmosphere.js").setCallback(
                    new Callback<Void, Exception>() {
                        ...
                        public void onSuccess(Void result) {
                            ...
                            socket = AtmosphereSocket.create(SearchConnectionImpl.this, urlBase);
                            socket.connect();
                        }
