...
public class AtmosphereChannel extends WebSocketChannel {
	 ...
	 *
	 * @param callback
	 *            A ProtoCallback instance called with incoming messages.
	 */
	...
	/**
	 * A new resource connection has been associated with this channel
	 * 
	 * @param resource
	 *            the Atmosphere resource object
	 */
	public void onConnect(AtmosphereResource resource) {

		// Create a new broadcaster to publish to this resource
		broadcaster = resource.getAtmosphereConfig().getBroadcasterFactory().get();
