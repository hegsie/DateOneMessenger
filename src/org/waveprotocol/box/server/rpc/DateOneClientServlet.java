...
import org.waveprotocol.box.server.gxp.DateOneClientPage;
...
@Singleton
public class DateOneClientServlet extends HttpServlet {

  private static final Log LOG = Log.get(DateOneClientServlet.class);
...
//    String userDomain = id.getDomain();
    ...
    try {
      DateOneClientPage.write(response.getWriter(), new GxpContext(request.getLocale()),
